...
{
    internal abstract class ReadEvalPrintLoop
    {
        private bool _done; 
        ...
        private static void HandleRightArrow(IReadOnlyList<string> document, SubmissionView view)
        {
        ...
        private static void HandleDownArrow(ICollection document, SubmissionView view)
        {
        ...
        private static void HandleBackspace(IList<string> document, SubmissionView view)
        {
        ...
        private static void HandleDelete(IList<string> document, SubmissionView view)
        {
            var lineIndex = view.CurrentLine;
            var line = document[lineIndex];
            var start = view.CurrentCharacter;
        ...
        private static void HandleEnd(IReadOnlyList<string> document, SubmissionView view)
        {
            view.CurrentCharacter = document[view.CurrentLine].Length;
        }

        private static void HandleTab(IList<string> document, SubmissionView view)
        {
        ...
        private static void HandleTyping(IList<string> document, SubmissionView view, string text)
        {
            var lineIndex = view.CurrentLine;
            var start = view.CurrentCharacter;
